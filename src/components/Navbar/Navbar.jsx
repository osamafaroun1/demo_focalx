    ...
    <>
            ...
            </a>
              {
                ...
                <div style={{ boxShadow: ' 0px 4px 8px 0px rgba(0, 0, 0, 0.17)' }} className='rounded-b-[0.625rem] bg-my-white'>
                  <ul className='flex flex-col justify-center items-center leading-normal pt-[0.81rem] pb-[0.75rem] pl-[0.62rem] pr-[0.56rem] text-my-secoundry font-my-font font-normal not-italic text-xs'>
                    ...
                    <li className='pb-[0.5rem]'><a href="#acheive">Achievement</a></li>
                    <li className='pb-[0.5rem]'><a>Search for ID</a></li>
                  </ul>
                </div>
              }
            </li>
            <li className='w-[4.6875rem]'><a href="#contatUs" className='cursor-pointer' onClick={() => { setNavLinks_6(!navLinks_6), setNavLinks_1(''), setNavLinks_3(''), setNavLinks_4(''), setNavLinks_5(''), setNavLinks_2('') }}><span className={navLinks_6 ? ' of-navLinksNoSelected' : ' of-navLinksSelected'}>Let’s</span> <span className={navLinks_6 ? 'osama font-my-font text-my-black' : 'osama font-my-font text-my-secoundry'}>Talk</span></a></li>
          </ul>
      ...
      {navCollapse && <div className='rounded-md sm:hidden of-navbar-mobile'>
        <ul className='flex flex-col items-center gap-[30px] py-5 of-navbar-mobile-links'>
          <li className='w-[3.125rem]'><a className='cursor-pointer' onClick={() => { setNavLinks_1(!navLinks_1), setNavLinks_2(''), setNavLinks_3(''), setNavLinks_4(''), setNavLinks_5(''), setNavLinks_6('') }}><span className={navLinks_1 ? 'of-navLinksNoSelected' : 'of-navLinksSelected'}>Hom</span><span className={navLinks_1 ? 'font-my-font text-my-black' : 'font-my-font text-my-secoundry'}>e</span></a></li>
          <li className='w-[4.1875rem]'><a className='cursor-pointer' onClick={() => { setNavLinks_2(!navLinks_2), setNavLinks_1(''), setNavLinks_3(''), setNavLinks_4(''), setNavLinks_5(''), setNavLinks_6('') }} ><span className={navLinks_2 ? 'of-navLinksNoSelected' : 'of-navLinksSelected'}>Servi</span><span className={navLinks_2 ? 'font-my-font text-my-black' : 'font-my-font text-my-secoundry'}>ces</span></a></li>
          <li className='w-[4.375rem]'><a className='cursor-pointer' onClick={() => { setNavLinks_3(!navLinks_3), setNavLinks_1(''), setNavLinks_2(''), setNavLinks_4(''), setNavLinks_5(''), setNavLinks_6('') }}><span className={navLinks_3 ? 'of-navLinksNoSelected' : 'of-navLinksSelected'}>Portf</span><span className={navLinks_3 ? 'font-my-font text-my-black' : 'font-my-font text-my-secoundry'}>olio</span> </a></li>
          <li ><a className='cursor-pointer' onClick={() => { setNavLinks_4(!navLinks_4), setNavLinks_1(''), setNavLinks_3(''), setNavLinks_2(''), setNavLinks_5(''), setNavLinks_6('') }}><span className={navLinks_4 ? 'of-navLinksNoSelected' : 'of-navLinksSelected'}>Clients &</span> <span className={navLinks_4 ? 'font-my-font text-my-black' : 'font-my-font text-my-secoundry'}>Partners</span></a></li>
          <li onClick={() => { handleDropDown() }} className=''><a className=' flex items-center cursor-pointer  gap-[3px]' onClick={() => { setNavLinks_5(!navLinks_5), setNavLinks_1(''), setNavLinks_2(''), setNavLinks_3(''), setNavLinks_4(''), setNavLinks_6('') }} ><span className={navLinks_5 ? 'of-navLinksNoSelected' : 'of-navLinksSelected'}>About</span><span className={navLinks_5 ? 'font-my-font text-my-black ' : 'font-my-font text-my-secoundry '}>Us</span>
            {
              dropDown ?
                <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g id="Group 76">
          ...
          <li className='w-[4.6875rem] cursor-pointer'><a   onClick={() => { setNavLinks_6(!navLinks_6), setNavLinks_1(''), setNavLinks_3(''), setNavLinks_4(''), setNavLinks_5(''), setNavLinks_2('') }}><span className={navLinks_6 ? 'of-navLinksNoSelected' : 'of-navLinksSelected'}>Let’s</span> <span className={navLinks_6 ? 'font-my-font text-my-black' : 'font-my-font text-my-secoundry'}>Talk</span></a></li>
        </ul>
      </div>}
    </>
  )
