...
const Intern = () => {
    return (
        <div className='intern pt-[5rem]' id='inter'>
            <div className="internTextS">
                <h1 className='internH'>X Internship</h1>
                <p className='InternPA'>In focal X agency We belive that every human need second chance, thats why, every season, our team holds an Intrenship camp all over the Arab world and the Middle East under the supervision of many specialists in several fields such as: Graphic Design, Branding, Marketing, Web/App Development, and enterprenurship.</p>
                <p className='typIn'></p>
                <p className='InternPA'>
                    At the end of each internship camp, the intern receives an experience certificate with an ID number,
                    in addition to a recommendation to enable him to work in other companies.<br/>
